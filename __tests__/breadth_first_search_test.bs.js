...
var BreadthFirstSearch$Algorithms = require("../src/graphs/BreadthFirstSearch.bs.js");

Jest.describe("Breadth First Search", (function (param) {
        Jest.test("single node", (function (param) {
                var match = BreadthFirstSearch$Algorithms.search({
                      hd: {
                        id: "A",
                        neighbours: /* [] */0
                      },
